...
<script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.5.0/Chart.min.js"></script>
  ...
  $sql = "SELECT * FROM event RIGHT JOIN vote ON event.event_id = vote.event_id;";
    $result = mysqli_query($conn,$sql);
    ?>
  <div class="body" style="position:absolute; top:15%; left:13%;display: none"  id="body">

    <div class="container" id="body">
      <h3 style="color:#3d4c53;">รายการที่ลงคะแนนแล้ว</h3>
      ...
      ?>
        <div class="card col-3" id="card" onmouseover="setblurCard(<?php echo $row["event_id"]; ?>);" onmouseout="removeblurCard(<?php echo $row["event_id"]; ?>)" style="border-radius:5px;background:#ffffff;height:220px; width:555px;">
          ...
          <a id="btn_vote_<?php echo $row["event_id"]; ?>" href="datavote.php?event_id=<?php echo $row["event_id"]; ?>&user_id=<?php echo $user_id; ?>&date=<?php echo $row['date_time']; ?>" class="btn btn-success btn_vote">โหวต</a>
